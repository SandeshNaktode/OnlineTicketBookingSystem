        ...
        <div class="col-sm-9">
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <th>Trailer</th>
                        <th><a href="${movie.trailer}">Watch Trailer</a></th>
                    </tr>                    
                </tbody>
            </table>
           ...
           <c:when test="${sessionScope.user ne null }">
			...
			<c:otherwise><hr>
                <h4 class="d-inline-block" style="font-style: italic;color:red;padding:10px;">Please login to book ticket</h4><hr>
                <a href="/login" class="btn btn-primary btn-sm px-3" style="font-size:20px ;margin-bottom:50px;margin-left:220px;font-weight:500">Login</a>
			</c:otherwise>                   
			</c:choose>
        </div>
    </div>
