            ...
            <div class="companies20-content">
                <div class="owl-one owl-carousel owl-theme">
                   <c:forEach items="${list}" var="m">
                    <div class="item">
                        <li>
                            <div class="slider-info banner-view bg bg2" style="background: url('${m.poster}') no-repeat;background-size:100% 100%;">
                        ...
                        <div class="item vhny-grid">
                            ...
                            <a href="mdetails/${m.mid }">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <h4> <span class="post"><span class="fa fa-clock-o"> </span>&nbsp;${m.mid }
            ...
            <div class="grids-main py-5">
                <div class="container py-lg-3">
                    <div class="headerhny-title">
                        <div class="w3l-title-grids">
                            <div class="headerhny-left">
                                <h3 class="hny-title">Must Watch</h3>
                            </div>
                            <div class="headerhny-right text-lg-right">
                                <h4><a class="show-title" href="movielist.jsp">Show all</a></h4>
                            </div>
